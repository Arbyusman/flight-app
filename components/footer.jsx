    ...
    <footer
     ...
     rounded sm:justify-center mt-12 ">
      <div className="container lg:flex lg:flex-wrap justify-between mx-auto md:grid md:grid-cols-5 md:grid-rows-1">
        ...
        <div className="mt-2 ">
          <h2 className=" text-gray-700 font-semibold rounded ">Take OFF Flight</h2>
        ...
        <div className="mt-3">
          <h2 className=" text-gray-900 ml-1 font-semibold rounded ">Our App</h2>
          <ul className="text-gray-600">
            <li className="">
              <Link href="#" className=" text-gray-600 md:p-0">
                <Image src={googlePlayImage} alt="Get on Google Play logo" width={100} />
              </Link>
            </li>
          </ul>
        </div>
